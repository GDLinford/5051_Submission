...
public class BuggyControl : MonoBehaviour
{
    ...
    public bool rearLeftActive;
    public bool rearRightActive;
    public bool steeringWheelActive;
    public bool engineActive;

    public bool dummyDestroyed;

    public ControlMode controlMode = ControlMode.simple;

    [HideInInspector] StateChanger stateChanger;
    ...
    void OnCollisionEnter(Collision collider)
    {
        ...
        if (collider.transform.root.GetComponent<BuggyControl>())
        {
            collider.transform.root.GetComponent<BuggyControl>().slip2 = Mathf.Clamp(collider.relativeVelocity.magnitude, 0.0f, 5.0f);
    ...
    void Update()
    {
        ...
        if (dummyBuggy.frontRightBalancedActive == true & frontRightActive == false)
        {
            frontRightActive = true;
        }

        if (dummyBuggy.frontLeftBalancedActive == true & frontLeftActive == false)
        {
            frontLeftActive = true;
        }

        if (dummyBuggy.rearRightBalancedActive == true & rearRightActive == false)
        {
            rearRightActive = true;
        }

        if (dummyBuggy.rearLeftBalancedActive == true & rearLeftActive == false)
        {
            rearLeftActive = true;
        }
        ...
        {
            speed += myRigidbody.velocity.magnitude * 1f;
        ...
        if (frontRightActive == true && frontLeftActive == true && rearLeftActive == true && rearRightActive == true && engineActive == true && steeringWheelActive == true && dummyDestroyed == false)
        {
            dummyBuggy.completed = true;
            Destroy(dummyBuggy.gameObject);
            Destroy(GarageDoor);
            dummyDestroyed = true;
        }
    }
